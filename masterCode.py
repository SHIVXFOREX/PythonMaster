        ...
        while True:
            ...
            if seconds == "06:31:00":
                ...
                if check:
                    ...
                    Initial_Balance = int(Iq.get_balance())
                    ...
                    while True:
                        ...
                        if firstCompound:
                            if compundingAmt > 100:
                                ...
                                sql = "UPDATE active SET acive = (%s) WHERE currency = (%s)";
                                val = ("1",ACTIVES)
                                cursor.execute(sql, val)

                                connection.commit()

                                print(cursor.rowcount, " Sleep record inserted.")
                                time.sleep(1800)
                        ...
                        counter = counter + 1
                        current_Bal = int(Iq.get_balance())
                        sql = "UPDATE active SET acive = (%s) WHERE currency = (%s)";
                        val = ("2",ACTIVES)
                        cursor.execute(sql, val)
                        ...
                        print(cursor.rowcount, " active record inserted.")
                        print("-------------------------------------")
